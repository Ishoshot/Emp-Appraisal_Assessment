...
<div id="page-wrapper" >
  ...
  <div class="row" style="margin-top:6%;">
    ...
    <div class="col-md-8">
      ...
      <?php require 'editlectprocess.php'; ?>
      <form action="" method="POST">

        <div class="form-group">
          <label>TITLE <span style="color:red;">*</span></label>
          <input type="text" style="padding:18px;" class="form-control" placeholder="Enter Appropraite Title"  name="title" autocomplete="off" value="<?php echo $sql->first()->title; ?>" required>
        </div>

        <div class="form-group">
          <label>SURNAME <span style="color:red;">*</span></label>
          <input type="text" style="padding:18px;" class="form-control" placeholder="Enter Your Surname"  name="surname" autocomplete="off" value="<?php echo $sql->first()->surname; ?>" required>
        </div>

        <div class="form-group" style="margin-top:2%;">
          <label>FIRSTNAME <span style="color:red;">*</span></label>
          <input type="text" style="padding:18px;" class="form-control" placeholder="Enter Your Firstname"  name="firstname" autocomplete="off" value="<?php echo $sql->first()->firstname; ?>" required>
        </div>

        <div class="form-group" style="margin-top:2%;">
          <label>IDENTITY NUMBER <span style="color:red;">*</span></label>
          <input type="text" style="padding:18px;" class="form-control" placeholder="Enter Your Identity Number"  name="matric" autocomplete="off" value="<?php echo $sql->first()->matric; ?>" required>
        </div>


        <div class="form-group" style="margin-top:2%;">
          <label>EMAIL ADDRESS <span style="color:red;">*</span></label>
          <input type="text" style="padding:18px;" class="form-control" placeholder="Enter Your Valid Email Address"  name="email" autocomplete="off" value="<?php echo $sql->first()->email; ?>" required>
        </div>


        <div class="form-group" style="margin-top:2%;">
          <label>PHONE NUMBER <span style="color:red;">*</span></label>
          <input type="text" style="padding:18px;" class="form-control" placeholder="Enter Your Phone Number"  name="phone" autocomplete="off" value="<?php echo $sql->first()->phone; ?>" required>
        </div>
