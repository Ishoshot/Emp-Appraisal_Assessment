...
<div class="row" style="margin-top:6%;">
  <div class="col-md-12 text-center">
      <?php 
      $sql = DB::getInstance()->query("SELECT * FROM users WHERE opt = 'lecturer' ORDER BY users_id desc");
      ...
      { ?> 
        <table class="table table-striped table-bordered text-center">
          <tr>
            ...
            <th style="text-align:center;">IDENTITY NO</th>
        ...
        foreach ($sql->results() as $sql) {?>
         <tr>
            ...
            <td>
            <a href="lectedit.php?id=<?php echo $sql->users_id; ?>">
             ...
             <td>
            <a href="lecttrash.php?id=<?php echo $sql->users_id; ?>">
              <span class="badge btn btn-primary">
      ...
      <div class="col-md-12 text-center">
        ...
        <div class="col-md-12 pad-top">
          <div class="div-square" style="padding:20px;">
            <a href="addlecturers.php?user=<?php echo $users_id; ?>" >
