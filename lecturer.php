...
<div class="row" style="margin-top:9%;">
      <div class="col-md-12 text-center">
        ...
        <?php
          $total = DB::getInstance()->query("SELECT c_id FROM complaints where lecturer = '$key'");
          if ($total->count()) {
        ?>
        <div class="col-md-6 pad-top">
          <div class="div-square" style="padding:20px;">
            <a href="complaints.php?user=<?php echo $users_id; ?>">
              <i class="fa fa-comments-o fa-5x"></i>
              <h4>You have <span class="badge" style="font-size:20px;"><?php echo $total->count(); ?></span> Complaint(s).</h4>
            </a>
          </div>
        </div>
        ...
        <div class="col-md-6 pad-top">
          <div class="div-square" style="padding:20px;">
            <a href="complaints.php?user=<?php echo $users_id; ?>">
              <i class="fa fa-comments-o fa-5x"></i>
              <h4>You do not have any Compliants yet !!!</h4>
            </a>
          </div>
        </div>
        <?php
        ...
        <?php
          $total = DB::getInstance()->query("SELECT a_id FROM praise where lecturer = '$key'");
          if ($total->count()) {
        ?>
        <div class="col-md-6 pad-top">
          <div class="div-square" style="padding:20px;">
            <a href="appraisals.php?user=<?php echo $users_id; ?>" >
              <i class="fa fa-envelope-o fa-5x"></i>
              <h4>You have <span class="badge" style="font-size:20px;"><?php echo $total->count(); ?></span> Appraisal(s).</h4>
            </a>
          </div>
        </div>
        ...
        <div class="col-md-6 pad-top">
          <div class="div-square" style="padding:20px;">
            <a href="appraisals.php?user=<?php echo $users_id; ?>" >
              <i class="fa fa-envelope-o fa-5x"></i>
              <h4>You do not have any Appraisals yet !!!</h4>
            </a>
          </div>
        </div>
        <?php
    ...
    <div class="row" style="margin-top:9%;">
      <div class="col-md-12 text-center">
        ...
        <div class="col-md-3 pad-top">
          <div class="div-square" style="padding:20px;">
            <a href="lprofile.php?user=<?php echo $users_id; ?>" >
